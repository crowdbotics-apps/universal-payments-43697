...
## Project Structure
    ...
    ├── universal_payments_43697  # Django project configurations
...
1. Clone this repo and `cd universal_payments_43697`
...
2. Clone this repo and `cd universal_payments_43697`
